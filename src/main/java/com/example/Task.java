 ...
 * 
 * The `Task` class implements the `Runnable` interface and provides a way to
 * execute a task with a specified execution time. The class logs the start and
 * end times of the task execution, and handles any interruptions that may occur
